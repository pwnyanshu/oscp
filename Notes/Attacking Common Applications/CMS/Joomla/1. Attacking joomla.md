...
In [[Notes/Attacking Common Applications/CMS/Joomla/0. Discovery & Enumeration|0. Discovery & Enumeration]] we got the admin user creds, lets use this creds to login
