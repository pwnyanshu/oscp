...
We will come across a wide variety of web applications such as 
- Content Management Systems (CMS),
- custom web applications, 
- intranet portals used by developers and sysadmins, 
- code repositories, 
...
- and more
which can be misconfigured or not patched, which can then be exploited
