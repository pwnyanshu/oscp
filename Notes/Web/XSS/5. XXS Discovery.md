...
```shell-session
hellopriyanshu2702@htb[/htb]$ git clone https://github.com/s0md3v/XSStrike.git
hellopriyanshu2702@htb[/htb]$ cd XSStrike
hellopriyanshu2702@htb[/htb]$ pip install -r requirements.txt
hellopriyanshu2702@htb[/htb]$ python xsstrike.py
...
```shell-session
hellopriyanshu2702@htb[/htb]$ python xsstrike.py -u "http://SERVER_IP:PORT/index.php?task=test" 
